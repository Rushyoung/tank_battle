...
public:
   ...
   * dispatch handlers that are ready to be send.
   */
   ...
   * be called in a thread in which the io_context's send member function is
   ...
   * Instead, it will be scheduled to send by the underlying io_context.
   *
   * @param f The function object to be called. The executor will make
   * a copy of the handler object as required. The function signature of the
   * function object must be: @code void function(); @endcode
   ...
   * which the io_context's send member function is currently being invoked.
   *
   * @param handler The handler to be called. The strand will make a copy of the
   * handler object as required. The function signature of the handler must be:
   * @code void handler(); @endcode
